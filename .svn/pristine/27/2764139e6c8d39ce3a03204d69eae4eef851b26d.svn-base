...
<tiles:insertDefinition name="defaultTemplate">
	<tiles:putAttribute name="body">
		<form:form method="POST" action="create" modelAttribute="userFormBean"
			class="form-horizontal" cssClass="form-fix">
			...
			<div class="form-group">
				<div class="col-sm-offset-1 col-sm-10">
					...
					<form:input type="text" title="You first name"
						path="user.firstName" class="form-control" />
				</div>
			</div>
			<div class="form-group">
				<div class="col-sm-offset-1 col-sm-10">
