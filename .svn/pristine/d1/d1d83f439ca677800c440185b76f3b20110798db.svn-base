...
public class UserListForm {
	...
	private List<String> alteredUsersIds = new ArrayList<String>();

	public List<String> getAlteredUsersIds() {
		return alteredUsersIds;
	}
	...
	void setAlteredUserId(String Id) {
		alteredUsersIds.add(Id);
	}

	@Override
	public String toString() {
		return "UserListForm [elementsPerPage=" + elementsPerPage
				+ ", listSize=" + listSize + ", userList=" + userList
				+ ", pageHolder=" + pageHolder + ", pageList=" + pageList
				+ ", alteredUsersIds=" + alteredUsersIds + "]";
	}
}
