		...
		<c:if test="${!empty topic.directions}">
			...
			<table class="table table-bordered table-hover table-striped">
				...
				<c:forEach items="${topic.directions}" var="direction">
					<tr>
						<td><a href="${pageContext.request.contextPath}/directions/${direction.id}">${direction.name}</a></td>
					</tr>
				</c:forEach>
			</table>
		</c:if>
		...
		<c:if test="${!empty topic.subtopics}">
			...
			<table class="table table-bordered table-hover table-striped">
				...
				<c:forEach items="${topic.subtopics}" var="subtopic">
					<tr>
						<td><a href="${pageContext.request.contextPath}/subtopics/${subtopic.id}">${subtopic.name}</a></td>
					</tr>
				</c:forEach>
			</table>
		</c:if>
