...
public class TopicController {
	...
	public String showTopicDetail(Model model, @PathVariable("topicId") Long id) {
	...
	public String editTopic2(@Valid @ModelAttribute("topic") Topic topic,
		...
		LOG.trace("editTopic name = " + topic.getTopicName());
		...
		try {
			...
			result.rejectValue("directions", "error.directions",
