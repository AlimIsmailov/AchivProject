...
public class GroupDaoImpl extends GenericDaoImpl<Group> implements IGroupDao {
	...
	@Override
	public List<Group> findByDirection(String directionName){
		List<Group> groups = new ArrayList<Group>();
		try{
			groups = entityManager.createNamedQuery("Group.findByDirectionName", Group.class)
					.setParameter("directionName", directionName).getResultList();
		}catch (PersistenceException e){
			return new ArrayList<Group>();
		}
		return groups;
	...
	@Override
	public List<Group> findStartBeforeDate(Date date){
		List<Group> foundGroups = new ArrayList<Group>();
		try {
			foundGroups = entityManager
					.createNamedQuery("Group.findStartBeforeDate", Group.class)
	...
	@Override
	public List<Group> findEndAfterDate(Date date) {
		List<Group> foundGroups = new ArrayList<Group>();
		try {
			foundGroups = entityManager
					.createNamedQuery("Group.findEndAfterDate", Group.class)
					.setParameter("end", date).getResultList();
		} catch (PersistenceException e) {
			return new ArrayList<Group>();
		}
	...
	@Override
	public List<Group> findStartBeforeDateByUser(Date date, String login) {
		List<Group> foundGroups = new ArrayList<Group>();
		try {
			foundGroups = entityManager
					.createNamedQuery("Group.findStartBeforeDateByUser",
	...
	@Override
	public List<Group> findEndAfterDateByUser(Date date, String login) {
		List<Group> foundGroups = new ArrayList<Group>();
		try {
			foundGroups = entityManager
					.createNamedQuery("Group.findEndAfterDateByUser",
							Group.class).setParameter("end", date)
					.setParameter("login", login).getResultList();
		} catch (PersistenceException e) {
			return new ArrayList<Group>();
	...
	@Override
	public List<Group> findByDirectionNameAndUser(String directionName, String login) {
		List<Group> foundGroups = new ArrayList<Group>();
		try {
			foundGroups = entityManager
					.createNamedQuery("Group.findByDirectionNameAndUser",
							Group.class).setParameter("directionName", directionName)
					.setParameter("login", login).getResultList();
		} catch (PersistenceException e) {
			return new ArrayList<Group>();
		}
	...
	@Override
	public List<Group> getFilteredGroups(String directionName, Date startFrom, Date startTo, Date endFrom, Date endTo) {
		List<Group> foundGroups = new ArrayList<Group>();
		try {
			foundGroups = entityManager
					.createNamedQuery("Group.getFilteredGroups", Group.class)
					.setParameter("directionName", directionName).setParameter("startFrom", startFrom).setParameter("startTo", startTo).setParameter("endFrom", endFrom).setParameter("endTo", endTo).getResultList();
		} catch (PersistenceException e) {
			return new ArrayList<Group>();
		}
		return foundGroups;
	...
	@Override
	public List<Group> getFilteredGroups(String directionName, Date startFrom, Date startTo, Date endFrom, Date endTo, String login) {
		List<Group> foundGroups = new ArrayList<Group>();
		try {
			foundGroups = entityManager
					.createNamedQuery("Group.getFilteredGroupsByLogin", Group.class)
					.setParameter("directionName", directionName).setParameter("startFrom", startFrom).setParameter("startTo", startTo).setParameter("endFrom", endFrom).setParameter("endTo", endTo).setParameter("login", login).getResultList();
		} catch (PersistenceException e) {
			return new ArrayList<Group>();
		}
		return foundGroups;
