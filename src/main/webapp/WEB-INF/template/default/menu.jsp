			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown"><spring:message code="label.administration"/><span
								class="caret"></span></a>
					...
					<security:authorize access="hasAnyRole('ROLE_STUDENT', 'ROLE_MANAGER')">
						<li class=""><a
							href="<spring:url value="/schedule" htmlEscape="true"/>"><spring:message
									code="label.schedule" /></a></li>
					</security:authorize>

					<security:authorize access="hasRole('ROLE_ADMIN')">
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown"><spring:message code="label.schedule" /><span
								class="caret"></span></a>
							<ul class="dropdown-menu" role="menu">
								<li><a
									href="<spring:url value="/adminschedule" htmlEscape="true"/>"><spring:message
											code="label.schedule" /></a></li>
								<li class=""><a
									href="<spring:url value="/location" htmlEscape="true"/>"><spring:message
											code="label.locations" /></a></li>
							</ul></li>
					</security:authorize>
					
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown"><spring:message code="label.locale" /><span
							class="caret"></span></a>
						<ul class="dropdown-menu" role="menu">
							<li><a
								href="<spring:url value="?locale=en" htmlEscape="true"/>">EN</a></li>
							<li class="divider"></li>
							<li><a
								href="<spring:url value="?locale=uk" htmlEscape="true"/>">UA</a></li>
							<li><a
								href="<spring:url value="?locale=ru" htmlEscape="true"/>">RU</a></li>
						</ul></li>
				...
				<security:authorize access="isAuthenticated()">
					<div class="dropdown-account">
						<div class="dropdown ">
							...
							<ul class="dropdown-menu" role="menu">
								<li><a href="<spring:url value="/profile/show/${authUserLogin}" htmlEscape="true"/>"><security:authentication
