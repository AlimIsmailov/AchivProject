...
public class UserFormValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		rejectIfLoginExist(user.getLogin(), "user.login", "label.userLoginExist", errors);
		
		logger.info("Check if email exist");
		rejectIfEmailExist(user.getEmail(), "user.email", "label.userEmailExist", errors);
	...
	public void rejectIfLoginExist(String targetArg, String formField, String errorLoginExist,
			Errors errors) {
	...
	public void rejectIfEmailExist(String targetArg, String formField, String errorEmailExist,
			Errors errors) {
